...
# this Code will help to schedule start the RDS databasrs using Lambda\cf3 \
\cf2 # Yesh \cf3 \
\cf2 # Version -- 2.0\cf3 \
\
\pard\pardeftab720\partightenfactor0
...
\
\cf4 def\cf3  \cf6 start_rds_all\cf5 ():\cf3 \
...
\
    ...
    \cf4 for\cf3  i \cf4 in\cf3  response\cf5 [\cf6 'DBInstances'\cf5 ]:\cf3 \
\pard\pardeftab720\partightenfactor0
\cf2 #The if condition below filters aurora clusters from single instance databases as boto3 commands defer to start the aurora clusters.\cf3 \
...
\cf2 #check if the RDS instance is part of the Auto-Shutdown group.\cf3 \
                    ...
                    \cf4 for\cf3  tag \cf4 in\cf3  resp2\cf5 [\cf6 'TagList'\cf5 ]:\cf3 \
                        \cf4 if\cf3  tag\cf5 [\cf6 'Key'\cf5 ]\cf7 \cb8 ==\cf3 \cb1 key \cf4 and\cf3  tag\cf5 [\cf6 'Value'\cf5 ]\cf7 \cb8 ==\cf3 \cb1 value\cf5 :\cf3 \
                            \cf4 if\cf3  i\cf5 [\cf6 'DBInstanceStatus'\cf5 ]\cf3  \cf7 \cb8 ==\cf3 \cb1  \cf6 'available'\cf5 :\cf3 \
                                \cf4 print\cf5 (\cf6 '\{0\} DB instance is already available'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBInstanceIdentifier'\cf5 ]))\cf3 \
                            \cf4 elif\cf3  i\cf5 [\cf6 'DBInstanceStatus'\cf5 ]\cf3  \cf7 \cb8 ==\cf3 \cb1  \cf6 'stopped'\cf5 :\cf3 \
                                client\cf5 .\cf3 start_db_instance\cf5 (\cf3 DBInstanceIdentifier \cf7 \cb8 =\cf3 \cb1  i\cf5 [\cf6 'DBInstanceIdentifier'\cf5 ])\cf3 \
                                \cf4 print\cf5 (\cf6 'Started DB Instance \{0\}'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBInstanceIdentifier'\cf5 ]))\cf3 \
                            \cf4 elif\cf3  i\cf5 [\cf6 'DBInstanceStatus'\cf5 ]\cf7 \cb8 ==\cf6 \cb1 'starting'\cf5 :\cf3 \
                                \cf4 print\cf5 (\cf6 'DB Instance \{0\} is already in starting state'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBInstanceIdentifier'\cf5 ]))\cf3 \
                            \cf4 elif\cf3  i\cf5 [\cf6 'DBInstanceStatus'\cf5 ]\cf7 \cb8 ==\cf6 \cb1 'stopping'\cf5 :\cf3 \
                                \cf4 print\cf5 (\cf6 'DB Instance \{0\} is in stopping state. Please wait before starting'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBInstanceIdentifier'\cf5 ]))\cf3 \
            ...
            \cf4 elif\cf3  i\cf5 [\cf6 'DBInstanceIdentifier'\cf5 ]\cf3  \cf4 in\cf3  v_readReplica\cf5 :\cf3 \
                \cf4 print\cf5 (\cf6 'DB Instance \{0\} is a Read Replica.'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBInstanceIdentifier'\cf5 ]))\cf3 \
            \cf4 else\cf5 :\cf3 \
                \cf4 print\cf5 (\cf6 'DB Instance \{0\} has a read replica. Cannot shutdown & start a database with Read Replica'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBInstanceIdentifier'\cf5 ]))\cf3 \
\
            ...
            \cf4 for\cf3  tag \cf4 in\cf3  resp2\cf5 [\cf6 'TagList'\cf5 ]:\cf3 \
                \cf4 if\cf3  tag\cf5 [\cf6 'Key'\cf5 ]\cf7 \cb8 ==\cf3 \cb1 key \cf4 and\cf3  tag\cf5 [\cf6 'Value'\cf5 ]\cf7 \cb8 ==\cf3 \cb1 value\cf5 :\cf3 \
                    \cf4 if\cf3  i\cf5 [\cf6 'Status'\cf5 ]\cf3  \cf7 \cb8 ==\cf3 \cb1  \cf6 'available'\cf5 :\cf3 \
                        \cf4 print\cf5 (\cf6 '\{0\} DB Cluster is already available'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBClusterIdentifier'\cf5 ]))\cf3 \
                    \cf4 elif\cf3  i\cf5 [\cf6 'Status'\cf5 ]\cf3  \cf7 \cb8 ==\cf3 \cb1  \cf6 'stopped'\cf5 :\cf3 \
                        client\cf5 .\cf3 start_db_cluster\cf5 (\cf3 DBClusterIdentifier\cf7 \cb8 =\cf3 \cb1 i\cf5 [\cf6 'DBClusterIdentifier'\cf5 ])\cf3 \
                        \cf4 print\cf5 (\cf6 'Started Cluster \{0\}'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBClusterIdentifier'\cf5 ]))\cf3 \
                    \cf4 elif\cf3  i\cf5 [\cf6 'Status'\cf5 ]\cf7 \cb8 ==\cf6 \cb1 'starting'\cf5 :\cf3 \
                        \cf4 print\cf5 (\cf6 'cluster \{0\} is already in starting state.'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBClusterIdentifier'\cf5 ]))\cf3 \
                    \cf4 elif\cf3  i\cf5 [\cf6 'Status'\cf5 ]\cf7 \cb8 ==\cf6 \cb1 'stopping'\cf5 :\cf3 \
                        \cf4 print\cf5 (\cf6 'cluster \{0\} is in stopping state. Please wait before starting'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBClusterIdentifier'\cf5 ]))\cf3 \
                \cf4 elif\cf3  tag\cf5 [\cf6 'Key'\cf5 ]\cf3  \cf7 \cb8 !=\cf3 \cb1  key \cf4 and\cf3  tag\cf5 [\cf6 'Value'\cf5 ]\cf3  \cf7 \cb8 !=\cf3 \cb1  value\cf5 :\cf3 \
                    \cf4 print\cf5 (\cf6 'DB Cluster \{0\} is not part of autoshutdown'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBClusterIdentifier'\cf5 ]))\cf3 \
                \cf4 else\cf5 :\cf3 \
                    \cf4 print\cf5 (\cf6 'DB Instance \{0\} is not part of autoShutdown'\cf5 .\cf6 format\cf5 (\cf3 i\cf5 [\cf6 'DBClusterIdentifier'\cf5 ]))\cf3 \
\
\pard\pardeftab720\partightenfactor0
